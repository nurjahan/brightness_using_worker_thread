...
I used worker thread to do several tasks parallelly which are independent to each other  .It reduced execution time to half than the execution time for single thread.